...
<script>
	...
	//"처리 중" 이미지와 배경을 표시
	  ...
	  document.getElementById('overlay').style.display = 'block';
		...
		//console.log(url + "?serviceKey=인증키&numOfRows=" + numOfRows	+ "&pageNo=" + pageNo + "&MobileOS=" + MobileOS + "&MobileApp="	+ MobileApp + "&_type=" + _type + "&arrange=" + arrange	+ "&contentTypeId=" + contentTypeId);
